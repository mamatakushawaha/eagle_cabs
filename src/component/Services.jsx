...
export default function Services() {
    ...
    return (
        <div className="w-6xl min-h-screen mx-auto bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 relative py-20 px-6 lg:px-8 overflow-hidden">


            {/* Background Elements */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-orange-300/10 to-pink-300/10 rounded-full blur-3xl"></div>
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-blue-300/10 to-purple-300/10 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-yellow-600 mb-4">
                    Our Services
                </h2>
                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                data-index={index}
                                className={`relative flex gap-10 items-center ${isLeft ? 'justify-start' : 'justify-end'} transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                                    }`}
                                ...
                                <div className={`relative z-10 flex items-center gap-18 w-full max-w-4xl ${isLeft ? 'flex-row' : 'flex-row-reverse'
                                    ...
                                    <div className="relative group">
                                        <div className={`w-80 h-80 rounded-full overflow-hidden shadow-2xl transition-all duration-500 ${hoveredIndex === index ? 'scale-105 shadow-3xl' : ''
                                            ...
                                            {/* Floating Icon */}
                                            {/* <div className={`absolute top-6 right-6 w-12 h-12 rounded-full bg-gradient-to-r ${service.gradient} flex items-center justify-center shadow-lg transition-all duration-500 ${hoveredIndex === index ? 'scale-110' : 'scale-100'
                                                }`}>
                                            ...
                                            {/* <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                                                <div className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center transform scale-75 group-hover:scale-100 transition-transform duration-500">
