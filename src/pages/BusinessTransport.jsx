...
export default function BusinessTransport() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100 relative overflow-hidden">
      ...
      <div className="relative lg:px-6 lg:py-16 px-2 py-4 max-w-5xl mx-auto">
        {/* Hero Title Section */}
        <div className="text-center mt-15 lg:mt-10  lg:mb-10">
          <div className="inline-block">
            <h1 className="text-3xl md:text-4xl font-heading font-bold  text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 mb-4 leading-tight">
        ...
        <div className="grid lg:grid-rows-2 gap-10 items-center mb-20">
          ...
          <div className="relative">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-4 lg:p-10 shadow-2xl border border-orange-100 hover:shadow-3xl transition-all duration-500 hover:scale-[1.02]">
              {/* Content */}
              <div className="space-y-6 text-justify mb-8">
                <p className="text-gray-700 leading-relaxed font-body lg:text-lg">
              ...
              {/* Highlights Grid */}
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-4 lg:p-6">
          ...
          <div className="relative">
            <div className="relative group">
              ...
              <div className="bg-gradient-to-br from-orange-100 to-amber-100 rounded-3xl p-4 sm:p-6 shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500">
                <div className="relative">
                  {/* Business Image */}
                  <div className="w-full h-64 sm:h-80 lg:h-96 bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  {/* Floating Badge */}
                  <div className="absolute top-4 sm:top-6 left-4 sm:left-6 bg-gradient-to-r from-orange-600 to-amber-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-2xl flex items-center space-x-2 sm:space-x-3 shadow-xl backdrop-blur-sm border border-white/20 group-hover:scale-105 transition-transform duration-300 text-sm sm:text-base">
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 bg-white/90 backdrop-blur-sm rounded-2xl p-3 sm:p-4 shadow-xl border border-orange-100 hover:scale-105 transition-transform duration-300">
              ...
              <div className="absolute -top-4 sm:-top-6 -right-4 sm:-right-6 bg-white/90 backdrop-blur-sm rounded-2xl p-3 sm:p-4 shadow-xl border border-orange-100 hover:scale-105 transition-transform duration-300">
                <div className="text-center">
                  <div className="text-xl sm:text-2xl font-bold text-orange-600">100%</div>
                  <div className="text-xs sm:text-sm text-gray-600">Reliable</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4">
            {/* Feature Card 1 */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              <div className="bg-gradient-to-br from-orange-500 to-amber-500 p-3 sm:p-4 rounded-2xl w-fit mb-6">
                <Users className="text-white w-6 h-6 sm:w-8 sm:h-8" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Experienced Drivers</h3>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Real-time Tracking</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Premium Fleet</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Scalable Solutions</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">Cost Management</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl hover:scale-105 transition-all duration-500">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3">24/7 Support</h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
        ...
        {/* Statistics Section */}
        <div className="mb-20">
          <div className="bg-gradient-to-br from-orange-600 to-amber-600 rounded-3xl p-6 sm:p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:gap-6 gap-4">
                <div className="text-center group hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-orange-100 text-sm sm:text-base">Corporate Clients</div>
                </div>
                <div className="text-center group hover:scale-105 transition-transform duration-300">
                  <div className="text-3xl sm:text-4xl font-bold mb-1 sm:mb-2">1M+</div>
                  <div className="text-orange-100 text-sm sm:text-base">Safe Rides</div>
                </div>
                <div className="text-center group hover:scale-105 transition-transform duration-300">
                  <div className="text-3xl sm:text-4xl font-bold mb-1 sm:mb-2">99.5%</div>
                  <div className="text-orange-100 text-sm sm:text-base">On-Time Rate</div>
                </div>
                <div className="text-center group hover:scale-105 transition-transform duration-300">
                  <div className="text-3xl sm:text-4xl font-bold mb-1 sm:mb-2">15+</div>
                  <div className="text-orange-100 text-sm sm:text-base">Years Experience</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-20">
          {/* Heading */}
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-600 mb-3 sm:mb-4">
              Our Services
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {/* Card 1 */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-orange-100 hover:shadow-2xl transition-all duration-500">
        ...
        <div className="text-center px-4 sm:px-6 lg:px-8">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl border border-orange-100 hover:shadow-3xl transition-all duration-500">
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center items-center">
              {/* Phone */}
              <div className="flex items-center space-x-3 text-gray-600 w-full sm:w-auto justify-center sm:justify-start">
                <div className="bg-gradient-to-br from-orange-500 to-amber-500 p-3 rounded-full">
                  <Phone className="text-white w-4 h-4 lg:w-5 lg:h-5" />
                </div>
              ...
              <div className="flex items-center space-x-3 text-gray-600 w-full sm:w-auto justify-center sm:justify-start">
                <div className="bg-gradient-to-br from-orange-500 to-amber-500 p-3 rounded-full">
                  <Mail className="text-white w-4 h-4 lg:w-5 lg:h-5" />
                </div>
                <div className="text-sm sm:text-base">
                  <div className="font-semibold text-gray-800">Email Us</div>
                  <div className="text-orange-600 font-bold text-base sm:text-lg break-words">
                    business@eaglecabs.com
                  </div>
                </div>
              </div>
            </div>
