...
export default function About() {
  return (
    <div className="min-h-screen w-full lg:w-8xl bg-gradient-to-br from-orange-50 via-white to-yellow-50">
      {/* Hero Section with Background Pattern */}
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-yellow-500/10"></div>
        <div className="absolute top-0 left-0 w-full h-full">
          {/* responsive circle sizes, but keep original positioning */}
          <div className="absolute top-10 left-10 w-16 sm:w-20 h-16 sm:h-20 bg-orange-200/30 rounded-full animate-pulse"></div>
          <div className="absolute top-32 right-10 sm:right-20 w-12 sm:w-16 h-12 sm:h-16 bg-yellow-200/40 rounded-full animate-bounce"></div>
          <div className="absolute bottom-20 left-1/4 w-10 sm:w-12 h-10 sm:h-12 bg-orange-300/25 rounded-full animate-ping"></div>
        </div>

        {/* Keep original lg width intact, but make it responsive on smaller screens */}
        <div className="relative w-full lg:w-5xl max-w-5xl mx-auto py-10 lg:py-15 px-4 sm:px-6 lg:px-6">
          ...
          <div className="mb-12 mt-10 text-center">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-700 mb-4">
      ...
      <div className="w-full lg:w-5xl max-w-5xl mx-auto px-4 sm:px-6 lg:px-6 mb-12">
        <div className="relative bg-gradient-to-r from-yellow-600 to-orange-400 text-center rounded-2xl shadow-2xl p-6 sm:p-8 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-white/10 backdrop-blur-sm"></div>
          <div className="absolute -top-10 -right-10 w-28 sm:w-40 h-28 sm:h-40 bg-white/10 rounded-full"></div>
          <div className="absolute -bottom-10 -left-10 w-24 sm:w-32 h-24 sm:h-32 bg-white/10 rounded-full"></div>
      ...
      <div className="w-full lg:w-5xl max-w-5xl mx-auto px-4 sm:px-6 lg:px-6 pb-16">
        <div className="space-y-6 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 py-12 sm:py-16">
        <div className="w-full lg:w-5xl max-w-5xl mx-auto px-4 sm:px-6 lg:px-6">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-3xl font-bold text-white mb-4">Our Journey in Numbers</h2>
